...
I ommited a few lines since there was still a lot of text, but essentially it outputs the red text with grep's own formatting for color, which seems to not translate well into a plain text file.
